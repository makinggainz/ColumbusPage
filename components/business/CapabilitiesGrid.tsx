...
/* ── Section: "Enterprise-grade capabilities" ────────────────────────────────
   ...
   transparent rounded corners), so the tile adds no border/radius of its own
   — that would double up as a visible frame. The image just renders at the
   cell width with its intrinsic aspect ratio. */
