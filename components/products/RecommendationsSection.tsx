...
export default function RecommendationsSection() {
  ...
  return (
    <section className="relative bg-[#F9F9F9] py-32 px-6 overflow-hidden" ref={sectionRef}>
      ...
      {/* Ambient AI gradient orbs — appear with the cards, positioned in the cards area */}
      <div
      ...
      <div className="relative z-10 max-w-[1730px] mx-auto">
        ...
        <div className="text-center mb-20">
          <h2
            className="text-[#1F6F6C] font-semibold text-[64px] leading-[140%] whitespace-nowrap tracking-[-0.02em]"
            style={fadeIn(0)}
          >
          ...
          <p
            className="text-[#1F6F6C] mt-2 text-[36px] font-medium leading-[140%] whitespace-nowrap tracking-[-0.02em]"
            style={fadeIn(0.1)}
          >
        ...
        <div className="flex items-center gap-6 mb-16 max-w-[560px] ml-[40px]">
          {/* Columbus logo — fades in with header */}
          <div
          ...
          {/* Text area — fixed min-height so layout doesn't jump; flex centers content vertically */}
...
function RecommendationCard({ "aria-hidden": ariaHidden }: { "aria-hidden"?: boolean } = {}) {
  ...
  return (
    ...
    >
      {/* Image: full-width minus 16px padding each side, 170px tall, 16px from top */}
