...
export const Careers = () => {
  ...
  return (
    <GridSection>
      <GridCell ref={ref} className="text-center pt-20 pb-24 px-8" style={anim(0)}>
      ...
      <GridCell className="px-8 md:px-10">
        <div
      ...
      <GridCell className="max-w-xl mx-auto px-8 pb-20" style={anim(200)}>
