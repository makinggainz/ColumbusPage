...
export const Careers = () => {
  return (
    <section className="py-[115px] md:py-[147px] lg:py-[179px]" style={{ backgroundColor: "rgba(255, 106, 61, 0.03)" }}>
      <Container>
        ...
        <div className="text-center mb-36 md:mb-44">
          ...
          >
            Hiring{" "}
            <span style={{ color: "#FF6A3D" }}>Humans.</span>
          </h2>
        ...
        <div
          ...
          style={{
            background: "linear-gradient(to right, rgba(255,106,61,0.35) 0%, rgba(255,106,61,0.18) 20%, rgba(255,106,61,0.03) 45%, rgba(255,106,61,0.03) 55%, rgba(255,106,61,0.18) 80%, rgba(255,106,61,0.35) 100%)",
          }}
          aria-hidden
        />
