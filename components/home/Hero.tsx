      ...
      <div className="relative z-10 pt-24 md:pt-32">
        <Container>
          <div className="max-w-292">
            ...
            <div>
            {/* Eyebrow */}
            <p className="text-sm md:text-base font-medium tracking-tight text-[#1C274C]/70 mb-4 text-left ml-0 pl-0 mt-15">
              A new breed of AI
            </p>

            {/* Main Heading — left edge aligned with Eyebrow */}
            <h1
              className={`${geist.className} font-[400] leading-tight tracking-tight text-[#0A1344] ml-0 pl-0 text-left`}
              style={{ fontSize: "66px" }}
            >
