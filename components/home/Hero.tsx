...
export const Hero = () => {
  ...
  return (
    ...
    >
      ...
      {/* Vertical structure lines — extend the IslandGap lines all the way up
          through the hero. Visible by default (no scroll trigger). The wrapper
          mirrors IslandGap's max-w-[1287px] mx-auto so the lines line up
          exactly with the ones in the gaps between sections below. */}
