...
export const Hero = () => {
  ...
  return (
    <section data-navbar-theme="dark" className="relative bg-[#07112A] min-h-[calc(100vh-576px)] overflow-hidden">
        ...
        <Container>
          <div className="max-w-292">
            <div>
              {/* Eyebrow */}
              <p
                className="text-sm md:text-base font-medium tracking-tight text-white/60 uppercase mb-4 text-left ml-0 pl-0 mt-15"
                style={fadeIn(0)}
              >
              ...
              <h1
                ...
                style={{ fontSize: "66px", color: "#E8EDF8", ...fadeIn(120) }}
              >
              ...
              {/* Tag */}
              <p
                className="mt-6 text-xs md:text-sm font-medium tracking-widest text-white/40"
                style={fadeIn(260)}
              >
                [ COLUMBUS PRO-1 ]
              </p>
