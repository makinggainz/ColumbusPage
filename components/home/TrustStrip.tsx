...
export const TrustStrip = () => {
  ...
  return (
    <GridSection>
      <GridCell ref={ref} className="flex flex-col items-center text-center px-8 pt-16 pb-4" style={anim(0)}>
        <h2 className="text-[#1D1D1F] text-[36px] md:text-[44px] font-bold tracking-[-0.02em] leading-[1.1]">
          Your plans are in good hands
        </h2>
      </GridCell>

      <GridCell className="flex items-center justify-center px-8 pb-12" style={anim(100)}>
