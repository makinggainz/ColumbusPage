...
export const SiteSelection = () => {
  ...
  return (
    <>
      ...
      <div style={{
        ...
        <div className="grid-section relative flex items-center justify-between max-w-[1287px] mx-auto px-8 min-[1287px]:px-10 py-6" style={anim(0)}>
          <div className="flex items-center gap-3">
            <span className="text-[18px] lg:text-[20px] text-white font-bold">
              Columbus Pro
            </span>
          ...
          <Link
            href="/maps-gpt"
            className="group flex items-center gap-3 min-[640px]:gap-10 text-[18px] lg:text-[20px] text-white font-semibold transition-opacity"
          >
      ...
      <GridSection className="[&::before]:hidden [&::after]:hidden bg-[#0B0B0B]!">
        ...
        >
          <div className="relative flex flex-col h-137.5 md:h-200 lg:h-250">
            ...
            <div className="relative z-10 flex flex-col flex-1 items-center pt-10 md:pt-16 lg:pt-24 px-6">
              ...
              <h2
                ref={headingRef}
                className="text-white text-center leading-[1.1] tracking-[-0.02em] text-[39px] md:text-[49px] lg:text-[76px]"
              ...
              {/* Subtitle */}
              <p className="mt-3 md:mt-4 lg:mt-6 text-center text-[16px] md:text-[20px]" style={{ color: "rgba(255,255,255,0.5)", letterSpacing: "-0.015em", fontWeight: 400 }}>
                Columbus turns you into a <span style={{ fontWeight: 600, color: "rgba(255,255,255,0.7)" }}>super-explorer.</span>
              </p>
    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          boxShadow: "inset 0 1px 2px rgba(255,255,255,0.04), 0 2px 12px rgba(0,0,0,0.2)",
        }}
      >
        {/* Sliding indicator */}
        <div
        ...
        {PILLS.map((label, i) => (
          <button
            ...
            onMouseEnter={e => {
              if (active !== i) (e.currentTarget as HTMLElement).style.color = "rgba(255,255,255,0.75)";
            }}
            onMouseLeave={e => {
              if (active !== i) (e.currentTarget as HTMLElement).style.color = "rgba(255,255,255,0.5)";
            }}
          >
            {label}
          </button>
        ...
        {PILLS.map((label, i) => (
          <button
            ...
            style={{
              ...
              fontWeight: 500,
              letterSpacing: "-0.01em",
              backgroundColor: active === i ? "rgba(255,255,255,0.12)" : "rgba(255,255,255,0.05)",
              color: active === i ? "#ffffff" : "rgba(255,255,255,0.5)",
              boxShadow: active === i ? "0 1px 4px rgba(0,0,0,0.2)" : "none",
            }}
          >
            {label}
          </button>
