        ...
        <div ref={ref}>
          ...
          <div className="relative">
            <div className="flex overflow-x-auto" style={{ scrollbarWidth: "none" }}>
                  ...
                  <Link href="/maps-gpt" className="group block">
                    <div className="relative w-full overflow-hidden" style={{ aspectRatio: "16 / 10" }}>
                      ...
                      <div className="absolute bottom-0 inset-x-0 px-5 pb-4">
                        <h3 className="font-semibold text-[17px] text-white tracking-[-0.01em] leading-tight mb-1">{spot.title}</h3>
              ...
              {/* See more CTA */}
              <div className="shrink-0 flex flex-col items-center justify-center" style={{ width: 200, ...anim(SPOTS.length * 60 + 150) }}>
