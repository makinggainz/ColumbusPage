...
function SpotCard({ spot }: { spot: (typeof SPOTS)[0] }) {
  return (
    <Link href="/maps-gpt" className="flex flex-col shrink-0 overflow-hidden rounded-lg transition-colors duration-300" style={{ width: 260, border: "0.75px solid var(--grid-line)", background: "rgba(37, 99, 235, 0.06)" }}
