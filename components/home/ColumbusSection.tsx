      ...
      <div className="max-w-[1287px] mx-auto px-6 min-[1287px]:px-0">
        ...
        <div className="pt-24 md:pt-32 flex flex-col md:flex-row md:items-start md:justify-between gap-6 md:gap-20 mb-16">
          <div className="flex-shrink-0">
            <span
              className="block text-[13px] font-medium text-[rgba(10,19,68,0.4)] mb-2"
          ...
          <p
            className="text-[16px] md:text-[17px] leading-[1.65] text-[rgba(10,19,68,0.55)] max-w-[380px] md:pt-8"
        ...
        <div className="flex gap-0" style={{ borderBottom: "1px solid rgba(10,19,68,0.08)" }}>
          {TABS.map((tab, i) => (
            <button
              ...
              className="relative py-3 px-5 md:px-6 text-[13px] md:text-[14px] font-medium cursor-pointer transition-colors duration-300"
              style={{
        ...
        <div className="py-20 md:py-28">
          <h3
            className="text-[24px] md:text-[28px] font-medium text-[#0A1344] mb-12"
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-x-12 gap-y-10">
            {FEATURES.map((f) => (
              <div key={f.title}>
                <h4 className="text-[15px] font-semibold text-[#0A1344] mb-2">{f.title}</h4>
                <p className="text-[14px] leading-[1.6] text-[rgba(10,19,68,0.5)]">{f.description}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="pb-20 md:pb-28">
          <h3
            className="text-[24px] md:text-[28px] font-medium text-[#0A1344] text-center mb-4"
            style={{ letterSpacing: "-0.02em" }}
          >
            Real outcomes, generated by Columbus
          </h3>
          <p className="text-[15px] text-[rgba(10,19,68,0.45)] text-center mb-12">
            ...
            {OUTCOMES.map((o) => (
              <div key={o.title} className="rounded-[20px] overflow-hidden">
                ...
                <div className="py-4 text-center">
                  <p className="text-[14px] font-medium text-[#0A1344]">{o.title}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="pb-20 md:pb-28">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              >
                <p className="text-[15px] leading-[1.65] text-[rgba(10,19,68,0.6)] mb-6">
                  &ldquo;{t.quote}&rdquo;
                </p>
                <div>
                  <p className="text-[14px] font-medium text-[#0A1344]">{t.author}</p>
                  <p className="text-[13px] text-[rgba(10,19,68,0.4)]">{t.company}</p>
                </div>
              </div>
            ))}
          </div>
