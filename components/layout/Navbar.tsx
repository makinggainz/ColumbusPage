...
export const Navbar = () => {
    ...
    return (
        <>
            ...
            isMenuOpen
            ? "border-b border-[#0a1628]/25 bg-white"
            : "border-b border-[#0a1628]/10 bg-white"
  }`}
            onMouseEnter={handleNavMouseEnter}
            onMouseLeave={handleMouseLeave}
    >

                <div className="relative z-50 mx-auto w-full max-w-[1200px] px-5 lg:px-8">
                <div className="flex h-[76px] items-center justify-between">
                    ...
                    <div className="flex items-center gap-10">
                        ...
                        <div className="hidden items-center gap-15 md:flex">
                           <Link
                             href="#"
                             className="group relative text-[18px] font-normal text-[#0a1628] transition-colors duration-300 hover:text-[#0A1344]"
                                >
                             Product
                        ...
                        <div className="flex items-center gap-8">
                            <Link
                                href="/maps-gpt"
                                className="h-[44px] min-w-[166px] border border-[#0A1344]/85 bg-[#FFFFFF] px-8 font-semibold text-[#0A1344]/75 transition-colors hover:bg-[#0A1344]/5 flex items-center justify-center"
