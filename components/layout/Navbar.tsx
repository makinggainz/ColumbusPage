  ...
  return (
    <>
        ...
        <div className="mx-auto w-full max-w-screen-xl px-6 md:px-10">
          <div className="flex h-14 items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <Link
                href="/platform"
                className="hidden md:flex items-center justify-center h-9 px-5 bg-white text-black font-semibold hover:bg-white/90 transition-colors"
              ...
              >
                <span
                  className="absolute block h-px w-5 bg-white transition-all duration-300"
                  style={{
                ...
                />
                <span
                  className="absolute block h-px bg-white transition-all duration-200"
                  style={{
                    width: menuOpen ? 0 : 20,
      ...
      >
        ...
        <div className="flex flex-col justify-center flex-1 px-8 gap-1">
          {mobileLinks.map((link, i) => (
            <Link
              ...
              className="text-white/60 hover:text-white transition-colors duration-200 py-4 border-b border-white/[0.07]"
              style={{
          ...
          <Link
            href="/platform"
            onClick={() => setMenuOpen(false)}
            className="mt-8 flex items-center justify-center h-12 bg-white text-black font-semibold hover:bg-white/90 transition-colors"
            style={{ fontSize: "15px" }}
          >
            Start Now
          </Link>
        ...
        {/* Bottom: contact */}
        <div className="px-8 pb-12 text-white/25" style={{ fontSize: "13px" }}>
