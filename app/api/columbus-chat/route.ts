...
function buildSystemPrompt(): string {
  ...
  return [
    ...
    "Columbus Earth Inc. is an applied-AI lab building a thinking earth — the first production Large Geospatial Model. The website has these products and pages:",
    ...
    "- Company: about Columbus Earth Inc., its mission and team.",
