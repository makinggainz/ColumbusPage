...
export default function ContactPage() {
  ...
  return (
    <main className="relative min-h-screen" style={{ backgroundColor: "#F9F9F9" }}>
      ...
      {/* ── Hero ── */}
      <div className="relative z-10 pt-40 md:pt-48 pb-12 md:pb-16 px-8 md:px-10 text-center">
        <h1
      ...
      {/* ── Two-column layout with glass effect ── */}
      <div className="relative z-10 max-w-[1287px] mx-auto px-5 md:px-10 pb-12 md:pb-16">
