  ...
  return (
    <main className="relative min-h-screen" style={{ backgroundColor: "#F9F9F9" }}>
      ...
      <div
        ...
        style={{ height: "40%", background: "linear-gradient(to bottom, rgba(0, 102, 204, 0.15) 0%, rgba(0, 102, 204, 0.08) 60%, transparent 100%)", zIndex: 1 }}
        aria-hidden
      />
      ...
      {/* ── Hero ── */}
      <div className="relative z-10 pt-40 md:pt-48 pb-16 md:pb-20 px-8 md:px-10 text-center">
        <h1
      ...
      {/* ── Two-column layout ── */}
      <div className="relative z-10 max-w-[1287px] mx-auto px-5 md:px-10 pb-24 md:pb-32">
          ...
          <div style={{ border: "1px solid rgba(0,0,0,0.08)" }}>
            ...
            <div className="px-8 py-8" style={{ borderBottom: "1px solid rgba(0,0,0,0.08)" }}>
              <div className="flex items-center gap-2 mb-4">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                  ...
                  <circle cx="10" cy="10" r="4" stroke="#2563EB" strokeWidth="1.2" />
                  <line x1="10" y1="1" x2="10" y2="4" stroke="#2563EB" strokeWidth="1.2" />
                  <line x1="10" y1="16" x2="10" y2="19" stroke="#2563EB" strokeWidth="1.2" />
                  <line x1="1" y1="10" x2="4" y2="10" stroke="#2563EB" strokeWidth="1.2" />
                  <line x1="16" y1="10" x2="19" y2="10" stroke="#2563EB" strokeWidth="1.2" />
                </svg>
              </div>
            ...
            <div className="px-8 py-8" style={{ borderBottom: "1px solid rgba(0,0,0,0.08)" }}>
              <div className="flex items-center gap-2 mb-4">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                  ...
                  <line x1="2" y1="8" x2="18" y2="8" stroke="#2563EB" strokeWidth="1.2" />
                  <line x1="8" y1="2" x2="8" y2="18" stroke="#2563EB" strokeWidth="1.2" />
                </svg>
              </div>
              ...
              <p className="text-[15px] leading-[1.6] text-[#1D1D1F]">
                Email us at
                <br />
                <a href="mailto:press@columbus.earth" className="underline hover:opacity-70 transition-opacity font-medium">press@columbus.earth</a>
              </p>
            </div>
            ...
            <div className="px-8 py-8" style={{ borderBottom: "1px solid rgba(0,0,0,0.08)" }}>
              <div className="flex items-center gap-2 mb-4">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                  <circle cx="10" cy="10" r="9" stroke="#2563EB" strokeWidth="1.2" />
                  <path d="M10 5v5l3.5 3.5" stroke="#2563EB" strokeWidth="1.2" strokeLinecap="round" />
                </svg>
              </div>
              <h3 className="text-[18px] font-semibold text-[#1D1D1F] mb-3">Careers</h3>
              <p className="text-[15px] leading-[1.6] text-[#1D1D1F] mb-3">
                If you&apos;re excited about creating paradigm shifts in physical world understanding. Join us now.
              </p>
              <Link href="/careers" className="text-[15px] font-medium underline hover:opacity-70 transition-opacity text-[#1D1D1F]">
                View open positions ↗
              </Link>
            </div>
            ...
            <div className="px-8 py-8">
              <div className="flex items-center gap-2 mb-4">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                  <path d="M3 17V7l7-5 7 5v10H3z" stroke="#2563EB" strokeWidth="1.2" strokeLinejoin="round" />
                  <path d="M8 17v-5h4v5" stroke="#2563EB" strokeWidth="1.2" strokeLinejoin="round" />
                </svg>
              </div>
              ...
              <a href="mailto:invest@columbus.earth" className="text-[15px] font-medium underline hover:opacity-70 transition-opacity text-[#1D1D1F]">
              ...
              <form className="flex flex-col gap-6" onSubmit={e => e.preventDefault()}>
                ...
                <label className="flex flex-col gap-1">
                  ...
                  <input
                    ...
                    className="bg-transparent border-b border-[rgba(0,0,0,0.12)] focus:border-[#2563EB] outline-none py-2 text-[16px] text-[#1D1D1F] transition-colors duration-300"
                  />
                </label>
                ...
                {/* Message */}
                <label className="flex flex-col gap-1">
                  <span className="text-[14px] text-[#1D1D1F]">Tell us about your project, so we can connect you with the right team.<span className="text-[#2563EB]">*</span></span>
                  <textarea
                    name="message"
                    required
                    maxLength={500}
